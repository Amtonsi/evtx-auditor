...
def build_pdf(output_path: str | Path) -> Path:
    ...
    bullet_list(
        [
            ...
            "выявить Critical, Error и важные события безопасности за выбранный период анализа",
    ...
    label_box(
        ...
        "Количество дней задается в окне. Отсчет идет от самого позднего корректного события узла, а не от текущего времени компьютера.",
        x + 405,
        y - 66,
        365,
        66,
